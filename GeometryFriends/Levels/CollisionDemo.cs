...
{
    public class CollisionDemo : GameScreen
    {
        ...
        private void LoadCircles()
        {
            ...
            redCircles1 = new Circles(startPosition, endPosition, 4, 40, new Color(200, 0, 0, 175), Color.Black);
        ...
        public override void HandleInput(InputState input)
        {
            if (firstRun)
            {
                ScreenManager.AddScreen(new PauseScreen(GetTitle(), GetDetails(),3));
                firstRun = false;
            }
